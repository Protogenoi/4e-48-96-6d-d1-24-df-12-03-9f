...
ADL
   ...
   if ( aData["life_test_two_grade"] == "Red" )  {
          $(nRow).addClass( 'Red' );
}
   else  if ( aData["life_test_two_grade"] == "Amber" )  {
          $(nRow).addClass( 'Amber' );
    }
   else if ( aData["life_test_two_grade"] == "Green" )  {
          $(nRow).addClass( 'Green' );
    }
   else if ( aData["life_test_two_grade"] == "SAVED" )  {
          $(nRow).addClass( 'Purple' );
                    ...
                    "ajax": "datatables/Protection.php?EXECUTE=1",
                    "columns": [
                        {
                        ...
                        {"data": "life_test_two_added_date"},
                        {"data": "life_test_two_advisor"},
                        {"data": "life_test_two_company"},
                        {"data": "life_test_two_grade"},
                        {"data": "life_test_two_mark"},
                        {"data": "life_test_two_id",
                            "render": function (data, type, full, meta) {
                                return '<a href="tests/Protection.php?EXECUTE=2&TID=' + data + '"><i class="fa fa-search"></i></a>';
                            }}
                    ]
                });
