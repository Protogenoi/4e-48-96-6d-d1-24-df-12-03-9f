...
$DUPE_CHK->bindParam(':FK',$COMPANY_ENTITY_ID, PDO::PARAM_INT);
$DUPE_CHK->execute(); 
...
SET
    ...
    car_business_overview_id_fk =:FK");
        $UPDATE->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
SET
    ...
    car_business_overview_ch =:CH,
    car_business_overview_id_fk =:FK");
        $INSERT->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
car_risk_overview_id_fk=:FK");
        $UPDATE1->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
        ...
        echo " ABC $COMPANY_ENTITY_ID ABC $TPS_SUM_RISK ABC $TPS_COM_RISK ABC $TPS_IMPACT_RISK ABC $TPS_SCORE_RISK ABC $TPS_PRO_RISK <br>";
        echo " ABC $COMPANY_ENTITY_ID ABC $DU_SUM_RISK ABC $DU_COM_RISK ABC $DU_IMPACT_RISK ABC $DU_SCORE_RISK ABC $DU_PRO_RISK <br>";
        echo " ABC $COMPANY_ENTITY_ID ABC $DPRK_SUM_RISK ABC $DPRK_COM_RISK ABC $DPRK_IMPACT_RISK ABC $DPRK_SCORE_RISK ABC $DPRK_PRO_RISK <br>";
        echo " ABC $COMPANY_ENTITY_ID ABC $SAC_SUM_RISK ABC $SAC_COM_RISK ABC $SAC_IMPACT_RISK ABC $SAC_SCORE_RISK ABC $SAC_PRO_RISK <br>";
        echo " ABC $COMPANY_ENTITY_ID ABC $CH_SUM_RISK ABC $CH_COM_RISK ABC $CH_IMPACT_RISK ABC $CH_SCORE_RISK ABC $CH_PRO_RISK <br>";
...
car_risk_overview_ch_rp=:CH_RP,
car_risk_overview_id_fk=:FK");
        $INSERT1->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
$DUPE_CHK2->bindParam(':FK',$COMPANY_ENTITY_ID, PDO::PARAM_INT);
$DUPE_CHK2->execute(); 
...
WHERE
compliance_risk_overview_2_id_fk=:FK");
        $UPDATE2->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
car_risk_overview_rfa_rp=:RFA_RP,
compliance_risk_overview_2_id_fk=:FK");
        $INSERT2->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
$DUPE_CHK3->bindParam(':FK',$COMPANY_ENTITY_ID, PDO::PARAM_INT);
$DUPE_CHK3->execute(); 
...
compliance_risk_overview_3_id_fk=:FK");
        $UPDATE3->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
car_risk_overview_tc_rp=:TC_RP,
compliance_risk_overview_3_id_fk=:FK");
        $INSERT3->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
$DUPE_CHK->execute(); 
  $row=$DUPE_CHK->fetch(PDO::FETCH_ASSOC);
    ...
    car_remedial_action_1_id_fk=:FK");
            $UPDATE4->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
    ...
    car_remedial_action_2_id_fk=:FK");
            $UPDATE5->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
    ...
    car_remedial_action_3_id_fk=:FK");
            $UPDATE6->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
car_remedial_action_1_tps_srar=:TPS1,
 ...
 car_remedial_action_1_ch_owner=:CH7,
car_remedial_action_1_id_fk=:FK");
        $INSERT4->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
car_remedial_action_2_vc_srar=:VC1,
 ...
 car_remedial_action_2_rfa_owner=:RFA7,
car_remedial_action_2_id_fk=:FK");
        $INSERT5->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
...
car_remedial_action_3_mmc_srar=:MMC1,
 ...
 car_remedial_action_3_tc_owner=:TC7, 
car_remedial_action_3_id_fk=:FK");
        $INSERT6->bindParam(':FK', $COMPANY_ENTITY_ID, PDO::PARAM_STR);
