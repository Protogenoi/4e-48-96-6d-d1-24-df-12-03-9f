 <table id="pad" class="table table-hover">
    ...
    <?php $i='0'; foreach ($TodayPadList as $POD_ONE_VAR): ?>


        <?php
        $i++;
                $OVR_group = $POD_ONE_VAR['pad_statistics_group'];
                $OVR_id = $POD_ONE_VAR['pad_statistics_id'];
                $OVR_lead = $POD_ONE_VAR['pad_statistics_lead'];
                $OVR_closer = $POD_ONE_VAR['pad_statistics_closer'];
                $OVR_notes = $POD_ONE_VAR['pad_statistics_notes'];
                $OVR_status = $POD_ONE_VAR['pad_statistics_status'];
                $OVR_our_col = $POD_ONE_VAR['pad_statistics_col'];
                $OVR_our_date = $POD_ONE_VAR['pad_statistics_update_date'];
?>
