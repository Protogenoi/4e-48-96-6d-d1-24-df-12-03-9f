 <table id="pad" class="table table-hover">
    ...
    <?php $i='0'; foreach ($YesterdayPadList as $Yesterday_Pad): ?>


        <?php
        $i++;
                $PAD_group = $Yesterday_Pad['pad_statistics_group'];
                $PAD_id = $Yesterday_Pad['pad_statistics_id'];
                $PAD_lead = $Yesterday_Pad['pad_statistics_lead'];
                $PAD_closer = $Yesterday_Pad['pad_statistics_closer'];
                $PAD_notes = $Yesterday_Pad['pad_statistics_notes'];
                $PAD_status = $Yesterday_Pad['pad_statistics_status'];
                $PAD_our_col = $Yesterday_Pad['pad_statistics_col'];
                 $PAD_our_date = $Yesterday_Pad['pad_statistics_update_date'];
?>
