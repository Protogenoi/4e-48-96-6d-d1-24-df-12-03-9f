                ...
                if($paytype=='R') {
                    ...
                    if ($Rcheck->rowCount() >= 1) {
                       ...
                       $delete->execute();
                           ...
                           if($EXECUTE='1') {
                                                              if(isset($datefrom)) {
                               header('Location: ../Financials.php?RECHECK=y&datefrom='.$datefrom.'&dateto='.$dateto.'&commdate='.$commdate); die;    
                               }
                            header('Location: ../Financials.php?RECHECK=y'); die;    
                           }
                       }
                ...
                if ($Icheck->rowCount() >= 1) {  
                    ...
                    $update->execute();
                       ...
                       $delete->execute();   
                           ...
                           if($EXECUTE='1') {
                               if(isset($datefrom)) {
                               header('Location: ../Financials/'.$INSURER.'.php?RECHECK=y&datefrom='.$datefrom.'&dateto='.$dateto.'&commdate='.$commdate); die;    
                               }
                            header('Location: ../Financials/'.$INSURER.'.php?RECHECK=y'); die;    
                           }
                       }
                           
                    header('Location: ../Financial/'.$INSURER.'.php?RECHECK=y'); die; 
                    ...
                    if($AMOUNT<'0') {
                       ...
                       if(isset($EXECUTE)) {
                           if($EXECUTE='1') {
                               if(isset($datefrom)) {
                                   header('Location: ../Financials/'.$INSURER.'.php?INSURER='.$INSURER.'&RECHECK=y&datefrom='.$datefrom.'&dateto='.$dateto.'&commdate='.$commdate); die;   
                               }
                               header('Location: ../Financials/'.$INSURER.'.php?RECHECK=y&INSURER='.$INSURER); die;    
                               }
                               }             
                               header('Location: ../Financials/'.$INSURER.'.php?RECHECK=y&INSURER='.$INSURER); die;                                
                        }
                        ...
                        if(isset($EXECUTE)) {
                            if($EXECUTE='1') {
                                if(isset($datefrom)) {
                                       header('Location: ../Financials/'.$INSURER.'.php?INSURER='.$INSURER.'RECHECK=n&datefrom='.$datefrom.'&dateto='.$dateto.'&commdate='.$commdate); die;
                                       
                               }
                            header('Location: ../Financials/'.$INSURER.'.php?RECHECK=n&INSURER='.$INSURER); die;    
                           }
                       }
