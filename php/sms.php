...
$FullName= filter_input(INPUT_POST, 'FullName', FILTER_SANITIZE_SPECIAL_CHARS);
    ...
    $data22=$SELECTsms->fetch(PDO::FETCH_ASSOC);
...
$query = $pdo->prepare("INSERT INTO client_note set client_id=:search, client_name=:recipientholder, sent_by=:sentbyholder, note_type=:noteholder, message=:messageholder ");
...
header('Location: ../Life/ViewClient.php?smssent=y&search='.$search); die;
