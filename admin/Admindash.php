                                    ...
                                    <form class="form-horizontal" method="POST" action="php/AddCompanyDetails.php?company">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="companyname" name="companyname" placeholder="" class="form-control input-md" required="" <?php if (isset($cdname)) {
                            echo "value='$cdname'";
                        } ?> type="text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="contactname" name="contactname" placeholder="" class="form-control input-md" <?php if (isset($cdname)) {
                            echo "value='$cdcp'";
                        } ?>  type="text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="companynum" name="companynum" placeholder="" class="form-control input-md" required="" <?php if (isset($cdname)) {
                            echo "value='$cdcn'";
                        } ?>  type="text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="companyip" name="companyip" placeholder="192.169.1.1" class="form-control input-md" required="" <?php if (isset($cdname)) {
                            echo "value='$cdip'";
                        } ?>  type="text">
                                                </div>
                                            </div>
                        ...
                        if ($Googleselect == 'y') {
                            ...
                            <form class="form-horizontal" method="POST" action="php/AddGoogleDeveloper.php?add=y">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="googletrackingid" name="googletrackingid" placeholder="" <?php if (isset($gdtracking)) {
                            echo "value='$gdtracking'";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="googleapi" name="googleapi" placeholder="" <?php if (isset($gdapi)) {
                            echo "value='$gdapi'";
                        } ?> class="form-control input-md" type="text">
                                            <span class="help-block">developers.google.com</span>  
                                        </div>
                            ...
                            <form class="form-horizontal" method="POST" action="php/AddAPIKey.php?AddType=PostCode">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="PostCodeAPI" name="PostCodeAPI" placeholder="" <?php if (isset($PostCodeKey)) {
                                    ...
                                    <form class="form-horizontal" method="POST" action="php/Addsmsaccounts.php?addsms&provider=Twilio">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="smsusername" name="SID" placeholder="Used for Twilio REST API" class="form-control input-md" value="<?php if (isset($TWILIO_SID)) {
                                    echo $TWILIO_SID;
                                } ?>" required type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="smspassword" name="TOKEN" placeholder="" class="form-control input-md" value="<?php if (isset($TWILIO_TOKEN)) {
                                    echo $TWILIO_TOKEN;
    ...
    while ($result = $PRO_QRY->fetch(PDO::FETCH_ASSOC)) {
        ...
        ?>
                                            <form method="post" action="php/AddCompany.php?EXECUTE=1">       
                                                ...
                                                <td><input size="12" class="form-control" type="text" name="PRO_COMPANY" value="<?php if (isset($PRO_COMPANY)) {
            echo $PRO_COMPANY;
        } ?>" required></td>                      
                                                <td><input size="12" class="form-control" type="text" name="PRO_PERCENT" value="<?php if (isset($PRO_PERCENT)) {
                                    echo $PRO_PERCENT;
                                } ?>"></td>
                                                <td>
                                                    <select name="PRO_ACTIVE" class="form-control" required>
    ...
    ?>                                   
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featuredialler-0">
                                                <input name="featuredialler" id="featuredialler-0" value="0" <?php if (!isset($fdialler)) {
                            ...
                            echo 'checked="checked"';
                                            ...
                                            <label class="radio-inline" for="featuredialler-1">
                                                <input name="featuredialler" id="featuredialler-1" value="1" <?php if ($fdialler == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featureanalytics-0">
                                                <input name="featureanalytics" id="featureanalytics-0" value="0" <?php if (!isset($fanalytics)) {
                            echo 'checked="checked"';
                        } elseif ($fanalytics == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="fanalytics-1">
                                                <input name="featureanalytics" id="featureanalytics-1" value="1" <?php if ($fanalytics == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featuregmaps-0">
                                                <input name="featuregmaps" id="featuregmaps-0" value="0" <?php if (!isset($fgmaps)) {
                            echo 'checked="checked"';
                        } elseif ($fgmaps == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featuregmaps-1">
                                                <input name="featuregmaps" id="featuregmaps-1" value="1" <?php if ($fgmaps == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featuretwitter-0">
                                                <input name="featuretwitter" id="featuretwitter-0" value="0" <?php if (!isset($ftwitter)) {
                            echo 'checked="checked"';
                        } elseif ($ftwitter == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featuregmaps-1">
                                                <input name="featuretwitter" id="featuretwitter-1" value="1" <?php if ($ftwitter == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="callbacks-0">
                                                <input name="featurecallbacks" id="featurecallbacks-0" value="0" <?php if (!isset($fcallbacks)) {
                            echo 'checked="checked"';
                        } elseif ($fcallbacks == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featurecallbacks-1">
                                                <input name="featurecallbacks" id="featurecallbacks-1" value="1" <?php if ($fcallbacks == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="callbacks-0">
                                                <input name="featurepost_code" id="featurepost_code-0" value="0" <?php if (!isset($fpost_code)) {
                            echo 'checked="checked"';
                        } elseif ($fpost_code == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featurepost_code-1">
                                                <input name="featurepost_code" id="featurepost_code-1" value="1" <?php if ($fpost_code == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featuresintemail-0">
                                                <input name="featuresintemail" id="featuresintemail-0" value="0" <?php if (!isset($fintemails)) {
                            echo 'checked="checked"';
                        } elseif ($fintemails == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featuresintemail-1">
                                                <input name="featuresintemail" id="featuresintemail-1" value="1" <?php if ($fintemails == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featureclientemails-0">
                                                <input name="featureclientemails" id="featureclientemails-0" value="0" <?php if (!isset($fclientemails)) {
                            echo 'checked="checked"';
                            ...
                            echo 'checked="checked"';
                                            ...
                                            <label class="radio-inline" for="featureclientemails-1">
                                                <input name="featureclientemails" id="featureclientemails-1" value="1" <?php if ($fclientemails == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featurekeyfacts-0">
                                                <input name="featurekeyfacts" id="featurekeyfacts-0" value="0" <?php if (!isset($fkeyfactsemail)) {
                            echo 'checked="checked"';
                            ...
                            echo 'checked="checked"';
                                            ...
                                            <label class="radio-inline" for="featurekeyfacts-1">
                                                <input name="featurekeyfacts" id="featurekeyfacts-1" value="1" <?php if ($fkeyfactsemail == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featuregenemail-0">
                                                <input name="featuregenemail" id="featuregenemail-0" value="0" <?php if (!isset($fgenemail)) {
                            echo 'checked="checked"';
                        } elseif ($fgenemail == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featuregenemail-1">
                                                <input name="featuregenemail" id="featuregenemail-1" value="1" <?php if ($fgenemail == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featuresreemails-0">
                                                <input name="featuresreemails" id="featuresreemails-0" value="0" <?php if (!isset($frecemail)) {
                            echo 'checked="checked"';
                        } elseif ($frecemail == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featuresreemails-1">
                                                <input name="featuresreemails" id="featuresreemails-1" value="1" <?php if ($frecemail == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featuresms-0">
                                                <input name="featuresms" id="featuresms-0" value="0" <?php if (!isset($fsms)) {
                            echo 'checked="checked"';
                        } elseif ($fsms == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featuresms-1">
                                                <input name="featuresms" id="featuresms-1" value="1" <?php if ($fsms == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featurescal-0">
                                                <input name="featurescal" id="featurescal-0" value="0" <?php if (!isset($fcalendar)) {
                            echo 'checked="checked"';
                        } elseif ($fcalendar == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featurescal-1">
                                                <input name="featurescal" id="featurescal-1" value="1" <?php if ($fcalendar == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featureaudits-0">
                                                <input name="featureaudits" id="featureaudits-0" value="0" <?php if (!isset($faudits)) {
                            echo 'checked="checked"';
                        } elseif ($faudits == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featureaudits-1">
                                                <input name="featureaudits" id="featureaudits-1" value="1" <?php if ($faudits == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featurelife-0">
                                                <input name="featurelife" id="featurelife-0" value="0" <?php if (!isset($flife)) {
                            echo 'checked="checked"';
                        } elseif ($flife == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featurelife-1">
                                                <input name="featurelife" id="featurelife-1" value="1" <?php if ($flife == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featurepba-0">
                                                <input name="featurepba" id="featurepba-0" value="0" <?php if (!isset($fpba)) {
                            echo 'checked="checked"';
                        } elseif ($fpba == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featurepba-1">
                                                <input name="featurepba" id="featurepba-1" value="1" <?php if ($fpba == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featurepensions-0">
                                                <input name="featurepensions" id="featurepensions-0" value="0" <?php if (!isset($fpensions)) {
                            echo 'checked="checked"';
                        } elseif ($fpensions == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featurepensions-1">
                                                <input name="featurepensions" id="featurepensions-1" value="1" <?php if ($fpensions == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featurehome-0">
                                                <input name="featurehome" id="featurehome-0" value="0" <?php if (!isset($fhome)) {
                            echo 'checked="checked"';
                        } elseif ($fhome == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featurehome-1">
                                                <input name="featurehome" id="featurehome-1" value="1" <?php if ($fhome == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featureerror-0">
                                                <input name="featureerror" id="featureerror-0" value="0" <?php if (!isset($ferror)) {
                            echo 'checked="checked"';
                        } elseif ($ferror == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featureerror-1">
                                                <input name="featureerror" id="featureerror-1" value="1" <?php if ($ferror == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featuredealsheets-0">
                                                <input name="featuredealsheets" id="featuredealsheets-0" value="0" <?php if (!isset($fdealsheets)) {
                            echo 'checked="checked"';
                            ...
                            echo 'checked="checked"';
                                            ...
                                            <label class="radio-inline" for="featuredealsheets-1">
                                                <input name="featuredealsheets" id="featuredealsheets-1" value="1" <?php if ($fdealsheets == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4"> 
                                            <label class="radio-inline" for="featureemployee-0">
                                                <input name="featureemployee" id="featureemployee-0" value="0" <?php if (!isset($femployee)) {
                            echo 'checked="checked"';
                        } elseif ($femployee == '0') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                            ...
                                            <label class="radio-inline" for="featureemployee-1">
                                                <input name="featureemployee" id="featureemployee-1" value="1" <?php if ($femployee == '1') {
                            echo 'checked="checked"';
                        } ?> type="radio">
                                                1
                                            </label>
